...
# store_select = st.sidebar.selectbox('Select Store', ['Dyori', 'Qetest1', "Bibibox", "Iamjuliedu", "Prezzie"])
#
# if store_select == 'Dyori':
#     data_dir = os.path.join(BASE_DIR, 'data')
#     image_dir = os.path.join(BASE_DIR, 'images')
#     df_abandoned_checkouts = load_data(os.path.join(data_dir, 'dyori_AbandonedCheckouts.csv'))
#     df_cj = load_data(os.path.join(data_dir, 'dyori_CJ.csv'))
#     df_customers = load_data(os.path.join(data_dir, 'dyori_Customers_Dataset.csv'))
#     df_orders = load_data(os.path.join(data_dir, 'dyori_Orders_Dataset.csv'))
#     df_products = load_data(os.path.join(data_dir, 'dyori_Products_Dataset.csv'))
#
#     image_path = os.path.join(image_dir, 'dyori_img.jpg')
#     image = Image.open(image_path)
#     image_resized = image.resize((300, 100))
#     st.sidebar.image(image_resized)
#
# elif store_select == 'Qetest1':
#     data_dir = os.path.join(BASE_DIR, 'data')
#     image_dir = os.path.join(BASE_DIR, 'images')
#     df_abandoned_checkouts = load_data(os.path.join(data_dir, 'qetest1_AbandonedCheckouts.csv'))
#     df_cj = load_data(os.path.join(data_dir, 'qetest1_CJ.csv'))
#     df_customers = load_data(os.path.join(data_dir, 'qetest1_Customers_Dataset.csv'))
#     df_orders = load_data(os.path.join(data_dir, 'qetest1_Orders_Dataset.csv'))
#     df_products = load_data(os.path.join(data_dir, 'qetest1_Products_Dataset.csv'))
#
#     image_path = os.path.join(image_dir, 'QE.jpg')
#     image = Image.open(image_path)
#     image_resized = image.resize((300, 100))
#     st.sidebar.image(image_resized)
#
# elif store_select == 'Prezzie':
#     ...
#
# elif store_select == "Bibibox":
#     data_dir = os.path.join(BASE_DIR, 'data')
#     image_dir = os.path.join(BASE_DIR, 'images')
#     df_abandoned_checkouts = load_data(os.path.join(data_dir, 'bibibox_AbandonedCheckouts.csv'))
#     try:
#         df_cj = load_data(os.path.join(data_dir, 'bibibox_CJ.csv'))
#     except:
#         ...
#     df_customers = load_data(os.path.join(data_dir, 'bibibox_Customers_Dataset.csv'))
#     df_orders = load_data(os.path.join(data_dir, 'bibibox_Orders_Dataset.csv'))
#     df_products = load_data(os.path.join(data_dir, 'bibibox_Products_Dataset.csv'))
#
#     image_path = os.path.join(image_dir, 'bibibox.jpg')
#     image = Image.open(image_path)
#     image_resized = image.resize((300, 100))
#     st.sidebar.image(image_resized)
#
# elif store_select == "Iamjuliedu":
#     data_dir = os.path.join(BASE_DIR, 'data')
#     image_dir = os.path.join(BASE_DIR, 'images')
#     df_abandoned_checkouts = load_data(os.path.join(data_dir, 'iamjuliedu_AbandonedCheckouts.csv'))
#     try:
#         df_cj = load_data(os.path.join(data_dir, 'iamjuliedu_CJ.csv'))
#     except:
#         ...
#     df_customers = load_data(os.path.join(data_dir, 'iamjuliedu_Customers_Dataset.csv'))
#     df_orders = load_data(os.path.join(data_dir, 'iamjuliedu_Orders_Dataset.csv'))
#     df_products = load_data(os.path.join(data_dir, 'iamjuliedu_Products_Dataset.csv'))
#
#     image_path = os.path.join(image_dir, 'EDU.jpg')
#     image = Image.open(image_path)
#     image_resized = image.resize((300, 100))
#     st.sidebar.image(image_resized)
#
...
#                 add_tooltip_css()
#                 tooltip_html = render_tooltip(f"Total number of customers who made a payment: {total_paying_customers}")
#                 st.markdown(
#                     f"<h1 style='display: inline-block;'>Paying Customers{tooltip_html}</h1>", unsafe_allow_html=True
#                 )
#                 st.markdown(
#                     f"""
#                     <div class="card">
...
#         except:
#             st.markdown(
#                 "<h3 style='font-size: 30px; color: red; text-align: center;'><b>Data is currently unavailable.</b></h3>",
#                 unsafe_allow_html=True)
#
#         add_tooltip_css()
#         tooltip_html = render_tooltip("Preview of customer data filtered by the selected date range.")
#         st.markdown(
#             f"<h1 style='display: inline-block;'>Preview Filtered Customer Data {tooltip_html}</h1>",
#             unsafe_allow_html=True
#         )
...
#                     # Color the bars based on unique customers count
...
#                 repeat_customers = customer_summary1.shape[0]
#                 add_tooltip_css()
#                 tooltip_html = render_tooltip(f"Total repeat customers (with 2 or more sessions): {repeat_customers}")
...
#                     unsafe_allow_html=True)
#                 df_cj['Event_Time'] = pd.to_datetime(df_cj['Event_Time'], errors='coerce',
#                                                      utc=True)  # Ensure Event_Time is in datetime format
...
#             session_count_per_day['month'] = session_count_per_day['day'].dt.strftime(
#                 '%B %Y')  # Month-Year (e.g., January 2024)
#             session_count_per_day['month'] = session_count_per_day['day'].dt.strftime(
#                 '%Y-%m')  # Use Year-Month format (e.g., 2024-01)
...
#             st.markdown(
#                 f"<h1 style='display: inline-block;'>Session Count Visualizations (day, month, quarter, year){tooltip_html}</h1>",
#                 unsafe_allow_html=True)
...
#                 add_tooltip_css()
#                 tooltip_html = render_tooltip(
#                     f"The total time spent on the website across all sessions is {overall_sum}, and the average time spent per session is {overall_average}.")
...
#                 search_terms = df_cj['Search_Term'].dropna().astype(
#                     str)  # Ensure there are no NaN values and all are strings
...
#                 st.markdown(f"<h3 style='text-align: center;'>Top {top_n_products} Most Added Products to Cart</h3>",
#                             unsafe_allow_html=True)
...
#
#                 st.markdown(f"<h1 style='display: inline-block;'>Total Time Spent on Each Event {tooltip_html}</h1>",
#                             unsafe_allow_html=True)
...
#                 st.markdown(f"<h1 style='display: inline-block;'>Customers Rate Under 30 Second{tooltip_html}</h1>",
#                             unsafe_allow_html=True)
#                 st.markdown(
#                     f"""
#                                <div class="card">
...
#             st.markdown(f"<h1 style='display: inline-block;'>Total Orders Placed: Days of the Week {tooltip_html}</h1>",
#                         unsafe_allow_html=True)
...
#                 st.markdown(
#                     f"<h1 style='display: inline-block;'>Abandoned Orders {tooltip_html}</h1>", unsafe_allow_html=True
#                 )
#                 st.markdown(
#                     f"""
#                         <div class="card">
...
#                 top_n = st.slider("Select Top N Product Types to Display", min_value=1, max_value=len(product_counts),
#                                   value=5)
...
#                 st.markdown(
#                     f"<h1 style='display: inline-block;'>Most Sold Products {tooltip_html}</h1>", unsafe_allow_html=True
#                 )
...
#             unsold_products_grouped = unsold_products.groupby(['Product_ID', 'Product_Title', 'Product_Published_At'],
...
#                 st.markdown(
#                     f"<h1 style='display: inline-block;'>Average Revenue {tooltip_html}</h1>", unsafe_allow_html=True
#                 )
#                 st.markdown(
#                     f"""
#                                <div class="card">
...
#             st.markdown(f"<h1 style='display: inline-block;'>Total Revenue Placed: Hours of Day {tooltip_html}</h1>",
#                         unsafe_allow_html=True)
